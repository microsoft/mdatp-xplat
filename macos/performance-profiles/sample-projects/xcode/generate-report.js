...
Exclusions phase excluded folders: \`.build\`, \`DerivedData\`. Negative "files scanned"/"scan time" in the exclusions phase is a per-PID counter artifact — trust AV CPU as the signal.
